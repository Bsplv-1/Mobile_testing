...
class AddNewReminder : AppCompatActivity(), View.OnClickListener {
        ...
        lifecycleScope.launch {
            ...
            this.coroutineContext.let {
                ...
                if (long > 0) {
                    ...
                    toast("Reminder Aded Sucessfuly")
                    Activity.RESULT_OK
                    finish()
                } else {
                    toast("Reminder Aded Failed")
                }
            }
        }
    ...
    private fun onDateSelectionButtonClicked() {
        ...
        materialDateBuilder.setTitleText("Select aa date");
    ...
    private fun onTimeSelectionButtonClicked() {
        ...
        materialTimeBuilder.setTitleText("Select aa time")
    ...
    private fun markerButtonClicked() {
        ...
        materialDialogBuilder.setTitle("Pick aa Marker")
